...
class BalanceReconciliationService(BaseService):
    ...
    async def create_reconciliation(
        ...
        reconciliation_repo = await self._get_repository(BalanceReconciliationRepository)
        ...
        if "adjustment_amount" not in reconciliation_data_dict or reconciliation_data_dict["adjustment_amount"] is None:
    ...
    async def get_largest_adjustments(
        ...
        """
        reconciliation_repo = await self._get_repository(BalanceReconciliationRepository)
        return await reconciliation_repo.get_largest_adjustments(
            account_id, limit
        )
