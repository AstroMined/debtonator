...
class BillPaymentPatternService(BaseService):
    ...
    async def analyze_payment_patterns(
        ...
        avg_days, std_dev_days, min_days, max_days = (
            await pattern_repo.calculate_payment_frequency_metrics(payments)
        )
        ...
        avg_amount, std_dev_amount, min_amount, max_amount, total_amount = (
            await pattern_repo.calculate_amount_statistics(payments)
        )
        ...
        first_payment, last_payment = (
            await pattern_repo.get_date_range_for_pattern_analysis(
                payments,
