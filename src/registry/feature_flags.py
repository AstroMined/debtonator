...
class FeatureFlagRegistry:
    ...
    def register(
        ...
        with self._lock:
            ...
            self._flags[flag_name] = {
                "type": flag_type.value if isinstance(flag_type, FeatureFlagType) else flag_type,
                "value": default_value,
    ...
    def set_value(self, flag_name: str, value: Any) -> None:
        ...
        with self._lock:
            ...
            if old_value != value:
                ...
                observers = self._observers.copy()  # Copy to avoid issues if observers modify the list
    ...
    def _is_user_in_percentage(self, user_id: str, flag_name: str, percentage: float) -> bool:
        """
