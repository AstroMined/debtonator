...
class CashflowBase(BaseSchemaValidator):
    ...
    total_bills: MoneyDecimal = Field(
        ..., ge=Decimal("0"), description="Total amount of bills in forecast period"
    )

    total_income: MoneyDecimal = Field(
        ..., ge=Decimal("0"), description="Total amount of income in forecast period"
    )
    ...
    daily_deficit: MoneyDecimal = Field(..., description="Average daily deficit amount")
    yearly_deficit: MoneyDecimal = Field(..., description="Projected yearly deficit")
...
class CashflowUpdate(BaseSchemaValidator):
    ...
    forecast_date: Optional[datetime] = Field(
        None, description="Date and time of forecast in UTC timezone"
    )
    ...
    balance: Optional[MoneyDecimal] = Field(
        default=None, description="Current balance across all accounts"
    )

    forecast: Optional[MoneyDecimal] = Field(
        default=None, description="Projected balance at end of forecast period"
    )

    min_14_day: Optional[MoneyDecimal] = Field(
        default=None, description="Minimum funds required for next 14 days"
    )

    min_30_day: Optional[MoneyDecimal] = Field(
        default=None, description="Minimum funds required for next 30 days"
    )

    min_60_day: Optional[MoneyDecimal] = Field(
        default=None, description="Minimum funds required for next 60 days"
    )

    min_90_day: Optional[MoneyDecimal] = Field(
        default=None, description="Minimum funds required for next 90 days"
    )

    daily_deficit: Optional[MoneyDecimal] = Field(
        default=None, description="Average daily deficit amount"
    )

    yearly_deficit: Optional[MoneyDecimal] = Field(
        default=None, description="Projected yearly deficit"
    )
    ...
    hourly_rate_40: Optional[MoneyDecimal] = Field(
        default=None, description="Hourly rate needed at 40 hours per week"
    )

    hourly_rate_30: Optional[MoneyDecimal] = Field(
        default=None, description="Hourly rate needed at 30 hours per week"
    )

    hourly_rate_20: Optional[MoneyDecimal] = Field(
        default=None, description="Hourly rate needed at 20 hours per week"
    )
...
class CashflowFilters(BaseSchemaValidator):
    ...
    start_date: Optional[datetime] = Field(
        None, description="Filter cashflows starting from this date in UTC timezone"
    )
    end_date: Optional[datetime] = Field(
        None, description="Filter cashflows until this date in UTC timezone"
    )
    min_balance: Optional[MoneyDecimal] = Field(
        default=None, description="Minimum balance threshold for filtering"
    )

    max_balance: Optional[MoneyDecimal] = Field(
        default=None, description="Maximum balance threshold for filtering"
    )
