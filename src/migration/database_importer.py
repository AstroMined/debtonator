        ...
        try:
            ...
            for i in range(0, len(bills), batch_size):
                ...
                try:
                    ...
                    stats["errors"].append(f"Error importing bills batch {i//batch_size + 1}: {str(e)}")
        ...
        try:
            ...
            for i in range(0, len(income_entries), batch_size):
                ...
                try:
                    ...
                    await self.session.rollback()
                    stats["errors"].append(f"Error importing income batch {i//batch_size + 1}: {str(e)}")
        ...
        try:
            ...
            for i in range(0, len(forecasts), batch_size):
                ...
                try:
                    ...
                    await self.session.rollback()
                    stats["errors"].append(f"Error importing cashflow batch {i//batch_size + 1}: {str(e)}")
