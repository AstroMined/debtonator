...
def test_generate_bills_month_validation():
    ...
    with pytest.raises(ValidationError, match="Input should be less than or equal to 12"):
...
def test_generate_bills_year_validation():
    ...
    with pytest.raises(ValidationError, match="Input should be greater than or equal to 2000"):
        GenerateBillsRequest(month=3, year=1999)
    
    # Test year greater than 3000
    with pytest.raises(ValidationError, match="Input should be less than or equal to 3000"):
