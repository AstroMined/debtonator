...
from tests.helpers.schema_factories.income_schema_factories import create_income_schema
...
def test_create_income_schema_with_custom_metadata():
    ...
    schema = create_income_schema(account_id=4, amount=Decimal("1500.00"))
...
def test_create_income_schema_with_minimum_amount():
    ...
    schema = create_income_schema(account_id=5, amount=Decimal("0.01"))
...
def test_create_income_schema_with_minimum_source_length():
    ...
    schema = create_income_schema(account_id=7, source="A")  # Minimum one character
