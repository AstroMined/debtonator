...
from src.schemas.payments import PaymentCreate, PaymentDateRange, PaymentUpdate
...
def test_create_payment_schema_with_custom_sources():
    ...
    schema = create_payment_schema(amount=Decimal("200.00"), sources=sources)
...
def test_create_payment_date_range_schema_with_custom_values():
    ...
    schema = create_payment_date_range_schema(start_date=start_date, end_date=end_date)
...
def test_create_payment_date_range_schema_with_additional_fields():
    ...
    schema = create_payment_date_range_schema(
        include_pending=True, sort_by="date", sort_order="desc"
    )
