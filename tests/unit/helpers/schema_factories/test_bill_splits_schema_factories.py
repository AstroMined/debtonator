...
def test_create_bill_split_update_schema_with_custom_values():
    ...
    schema = create_bill_split_update_schema(
        id=6,
        amount=Decimal("300.75")
    )
...
def test_create_bill_split_response_schema():
    ...
    schema = create_bill_split_response_schema(
        id=13,
        liability_id=14,
        account_id=15
    )
...
def test_create_bill_split_validation_schema_with_custom_values():
    ...
    custom_splits = [
        create_bill_split_schema(liability_id=17, account_id=18, amount=Decimal("200.00")),
        create_bill_split_schema(liability_id=17, account_id=19, amount=Decimal("150.00")),
    ]
...
def test_create_bulk_operation_result_schema_with_errors():
    ...
    errors = [
        {"index": 0, "split_data": create_bill_split_schema(liability_id=1, account_id=1), 
         "error_message": "Invalid split", "error_type": "validation"}
    ]
