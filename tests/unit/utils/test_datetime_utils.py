...
from src.utils.datetime_utils import (  # Creation functions; Conversion functions; Comparison functions; Range operations
    date_equals,
    date_in_collection,
    date_range,
    datetime_equals,
...
class TestCreationFunctions:
    """Tests for datetime creation functions."""
    ...
    def test_naive_utc_from_date(self):
...
class TestConversionFunctions:
    ...
    def test_ensure_utc_with_naive(self):
    ...
    def test_ensure_utc_with_utc_and_naive(self):
    ...
    def test_ensure_utc_with_already_utc(self):
    ...
    def test_utc_datetime_from_str(self):
    ...
    def test_normalize_db_date(self):
...
class TestComparisonFunctions:
    """Tests for datetime and date comparison functions."""

    def test_datetime_equals_with_same_timezone(self):
    ...
    def test_datetime_equals_with_different_timezone(self):
    ...
    def test_datetime_equals_with_naive_and_aware(self):
    ...
    def test_datetime_equals_invalid_inputs(self):
    ...
    def test_datetime_greater_than(self):
    ...
    def test_date_in_collection(self):
    ...
    def test_is_adr011_compliant(self):
...
class TestRangeOperations:
    ...
    def test_is_month_boundary(self):
...
class TestRepositoryPatterns:
    """Tests for datetime utility usage in common repository patterns."""

    def test_inclusive_date_range_pattern(self):
