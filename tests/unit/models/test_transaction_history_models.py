...
async def test_create_transaction_history(db_session: AsyncSession, test_checking_account: Account):
...
async def test_transaction_history_relationships(db_session: AsyncSession, test_checking_account: Account):
...
async def test_transaction_history_string_representation(db_session: AsyncSession, test_checking_account: Account):
...
async def test_transaction_history_cascade_delete(db_session: AsyncSession, test_checking_account: Account):
...
async def test_transaction_types(db_session: AsyncSession, test_checking_account: Account):
...
async def test_optional_description(db_session: AsyncSession, test_checking_account: Account):
