...
@pytest.mark.asyncio
async def test_create_income(income_service: IncomeService, base_account: Account, db_session: AsyncSession):
...
@pytest.mark.asyncio
async def test_create_income_invalid_account(income_service: IncomeService, db_session: AsyncSession):
...
@pytest.mark.asyncio
async def test_get_income(income_service: IncomeService, base_income: Income, db_session: AsyncSession):
...
@pytest.mark.asyncio
async def test_update_income(income_service: IncomeService, base_income: Income, db_session: AsyncSession):
...
@pytest.mark.asyncio
async def test_update_income_not_found(income_service: IncomeService, db_session: AsyncSession):
...
async def test_update_income_deposit_status(
    ...
    assert updated_income.account.available_balance == original_balance + base_income.amount

@pytest.mark.asyncio
async def test_delete_income(income_service: IncomeService, base_income: Income, db_session: AsyncSession):
...
@pytest.mark.asyncio
async def test_delete_income_not_found(income_service: IncomeService, db_session: AsyncSession):
...
@pytest.mark.asyncio
async def test_get_undeposited(income_service: IncomeService, base_income: Income, db_session: AsyncSession):
...
@pytest.mark.asyncio
async def test_get_total_undeposited(income_service: IncomeService, base_income: Income, db_session: AsyncSession):
