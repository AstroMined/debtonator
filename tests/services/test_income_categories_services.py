...
@pytest.fixture
async def sample_category(income_category_service: IncomeCategoryService, db_session: AsyncSession):
...
async def test_update_nonexistent_category(income_category_service: IncomeCategoryService):
...
async def test_delete_nonexistent_category(income_category_service: IncomeCategoryService):
