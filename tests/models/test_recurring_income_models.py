...
async def test_cascade_delete_income_entries(
    ...
    income_entry1 = service.create_income_from_recurring(test_recurring_income, now.month, now.year)
    income_entry2 = service.create_income_from_recurring(test_recurring_income, now.month + 1, now.year)
