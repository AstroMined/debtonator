...
@pytest.fixture(scope="function")
async def test_income_record(db_session: AsyncSession, test_checking_account: Account) -> Income:
...
async def test_liability(
    ...
    naive_future_date = naive_utc_from_date(future_date.year, future_date.month, future_date.day)
