...
def create_income_trends_analysis_schema(
    ...
    include_seasonality: Optional[bool] = None,  # New parameter
    **kwargs: Any,
) -> Dict[str, Any]:
    """
    ...
    Args:
        ...
        include_seasonality: If True, always include seasonality; if False, never include;
                            if None, include randomly (about 50% of the time)
        **kwargs: Additional fields to override
