...
async def test_get_realtime_cashflow_with_deficit(db_session, sample_accounts, sample_bills):
    ...
    assert cashflow.total_available_funds == Decimal("200.00")  # Two accounts with 100 each
    assert cashflow.minimum_balance_required == Decimal("1350.00")
