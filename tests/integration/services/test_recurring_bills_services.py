...
@pytest.mark.asyncio
async def test_get_recurring_bill(db_session: AsyncSession, recurring_bill: RecurringBill):
...
@pytest.mark.asyncio
async def test_get_recurring_bills(db_session: AsyncSession, recurring_bill: RecurringBill):
...
@pytest.mark.asyncio
async def test_get_recurring_bills_active_only(db_session: AsyncSession, recurring_bill: RecurringBill):
...
@pytest.mark.asyncio
async def test_update_recurring_bill(db_session: AsyncSession, recurring_bill: RecurringBill):
    """Test updating a recurring bill"""
    service = RecurringBillService(db_session)
    
    update_data = RecurringBillUpdate(
        bill_name="Updated Bill",
...
@pytest.mark.asyncio
async def test_delete_recurring_bill(db_session: AsyncSession, recurring_bill: RecurringBill):
