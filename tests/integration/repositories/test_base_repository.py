...
class TestBaseRepository:
    """Tests for BaseRepository functionality using Account model as a test subject."""
    ...
    @pytest.mark.asyncio
    async def test_get_multi_with_skip_and_limit(self, db_session: AsyncSession):
    ...
    @pytest.mark.asyncio
    async def test_get_paginated(self, db_session: AsyncSession):
    ...
    async def test_bulk_update(self, db_session: AsyncSession):
        ...
        assert all(account.available_balance == Decimal("9999.00") for account in updated_accounts)
