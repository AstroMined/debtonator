...
class TestSavingsAccountRepository:
    ...
    @pytest.fixture
    async def savings_repository(self, db_session: AsyncSession, feature_flag_service: FeatureFlagService) -> AccountRepository:
    ...
    @pytest.fixture
    async def test_savings_with_interest(self, db_session: AsyncSession) -> SavingsAccount:
    ...
    @pytest.fixture
    async def test_savings_with_min_balance(self, db_session: AsyncSession) -> SavingsAccount:
    ...
    async def test_get_accounts_by_interest_rate_threshold(
        self, savings_repository: AccountRepository,
        ...
        if hasattr(test_savings_account, "interest_rate") and (test_savings_account.interest_rate is None or test_savings_account.interest_rate > Decimal("1.0")):
        ...
        if hasattr(test_savings_account, "interest_rate") and test_savings_account.interest_rate < Decimal("2.0"):
    ...
    async def test_get_accounts_with_minimum_balance(
        ...
        if not hasattr(test_savings_with_interest, "minimum_balance") or test_savings_with_interest.minimum_balance is None:
