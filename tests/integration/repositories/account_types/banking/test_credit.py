...
class TestCreditAccountRepository:
    ...
    @pytest.fixture
    async def credit_repository(self, db_session: AsyncSession, feature_flag_service: FeatureFlagService) -> AccountRepository:
    ...
    @pytest.fixture
    async def test_credit_with_due_date(self, db_session: AsyncSession) -> CreditAccount:
    ...
    async def test_get_credit_accounts_with_upcoming_payments(
        self, credit_repository: AccountRepository,
