...
class TestBalanceHistoryRepository:
    """
    Tests for the BalanceHistoryRepository.
    ...
    async def test_get_by_account(
        ...
        results = await balance_history_repository.get_by_account(test_account.id)
    ...
    async def test_get_latest_balance(
        ...
        result = await balance_history_repository.get_latest_balance(test_account.id)
    ...
    async def test_get_with_account(
        ...
        result = await balance_history_repository.get_with_account(
        ...
        assert result.account.name == test_account.name
        assert result.account.type == test_account.type
    ...
    async def test_get_balance_trend(
        ...
        trend = await balance_history_repository.get_balance_trend(test_account.id)
    ...
    async def test_get_average_balance(
        ...
        result = await balance_history_repository.get_average_balance(test_account.id)
    ...
    async def test_get_balance_history_with_notes(
        ...
        with_note1 = await balance_history_repository.create(
            with_note1_schema.model_dump()
        )
        no_note = await balance_history_repository.create(no_note_schema.model_dump())
        empty_note = await balance_history_repository.create(
            empty_note_schema.model_dump()
        )
        with_note2 = await balance_history_repository.create(
            with_note2_schema.model_dump()
        )
