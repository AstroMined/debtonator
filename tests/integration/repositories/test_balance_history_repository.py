...
async def balance_history_repository(db_session: AsyncSession) -> BalanceHistoryRepository:
...
class TestBalanceHistoryRepository:
    ...
    async def test_get_reconciled_balances(
        ...
        results = await balance_history_repository.get_reconciled_balances(test_account.id)
