...
class TestBNPLAccountCrud:
    ...
    async def test_get_bnpl_account(self, repository: AccountRepository, test_bnpl_account: BNPLAccount):
    ...
    async def test_update_bnpl_account(self, repository: AccountRepository, test_bnpl_account: BNPLAccount):
    ...
    async def test_delete_bnpl_account(self, repository: AccountRepository, test_bnpl_account: BNPLAccount):
