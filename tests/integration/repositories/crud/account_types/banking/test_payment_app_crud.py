...
class TestPaymentAppAccountCrud:
    ...
    async def test_get_payment_app_account(self, repository: AccountRepository, test_payment_app_account: PaymentAppAccount):
    ...
    async def test_update_payment_app_account(self, repository: AccountRepository, test_payment_app_account: PaymentAppAccount):
    ...
    async def test_delete_payment_app_account(self, repository: AccountRepository, test_payment_app_account: PaymentAppAccount):
