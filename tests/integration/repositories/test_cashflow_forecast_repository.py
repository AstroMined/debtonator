...
class TestCashflowForecastRepository:
    """
    Tests for the CashflowForecastRepository.
    ...
    async def test_delete_cashflow_forecast(
        ...
        deleted_forecast = await cashflow_forecast_repository.get(
            test_cashflow_forecast.id
        )
    ...
    async def test_get_by_date(
        ...
        test_date_naive = (
            test_date.replace(tzinfo=None) if test_date.tzinfo else test_date
        )
    ...
    async def test_get_by_date_range(
        ...
        results = await cashflow_forecast_repository.get_by_date_range(
            start_date, end_date
        )
    ...
    async def test_get_forecast_with_metrics(
        ...
        specific_date_result = (
            await cashflow_forecast_repository.get_forecast_with_metrics(
