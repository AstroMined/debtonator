...
class TestRepositoryFactory:
    ...
    @pytest.fixture
    async def test_checking_for_module(
    ...
    async def test_dynamic_method_binding(
        ...
        accounts_with_overdraft = (
            await checking_repo.get_checking_accounts_with_overdraft()
        )
    ...
    async def test_fallback_behavior_for_unknown_type(self, factory: RepositoryFactory):
