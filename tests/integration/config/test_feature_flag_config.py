...
class TestFeatureFlagConfig:
    ...
    async def test_configure_feature_flags(self, registry: FeatureFlagRegistry, repository: FeatureFlagRepository):
    ...
    async def test_configure_development_defaults(self, registry: FeatureFlagRegistry, repository: FeatureFlagRepository):
    ...
    async def test_idempotent_initialization(self, registry: FeatureFlagRegistry, repository: FeatureFlagRepository):
    ...
    async def test_flag_values_preserved(self, registry: FeatureFlagRegistry, repository: FeatureFlagRepository):
