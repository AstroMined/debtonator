...
- Fixed async relationship loading in recurring bills tests
  - Added proper async context management in relationship tests
  - Enhanced test fixtures with explicit relationship loading
  - Improved test assertions for relationship verification
  - Fixed MissingGreenlet error in SQLAlchemy async operations

## [0.3.26] - 2025-02-13

### Fixed
- Fixed category handling in bulk import and recurring bills
  - Fixed category relationship handling in recurring bills
  - Added proper category service integration in bulk import
  - Improved validation and error handling for categories
  - Enhanced test coverage for bulk imports
  - Added proper database session handling in tests
  - Fixed recurring bills test assertions
  - Updated recurring bill model to properly set category relationship
